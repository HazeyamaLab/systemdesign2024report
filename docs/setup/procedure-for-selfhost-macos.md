...
3. 開発コンテナーを作成します。
    ...
    3. 開発コンテナーの作成が完了するまで待ちます。開発コンテナーの作成には数分間かかることがあります。作成に成功すると自動的に開発コンテナーに接続され、ウインドウ左下のリモートボタンに`Dev Container: systemdesign2024report`と表示されます。
...
5. 開発コンテナーへの接続に成功すると、ウインドウ左下のリモートボタンに`Dev Container: systemdesign2024report`と表示されます。
